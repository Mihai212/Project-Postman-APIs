...
- [Status](#Status)
- [Products](#Products)
  - [A. Get all products](#Get-all-products)
  - [B. Get a product](#Get-a-product)
- [Cart](#Cart)
  - [A. Create a new cart](#Create-a-new-cart)
  - [B. Get a cart](#Get-a-cart)
  - [C. Get cart items](#Get-cart-items)
  - [D. Add an item to cart](#Add-an-item-to-cart)
  - [E. Modify an item in the cart](#Modify-an-item-in-the-cart)
  - [F. Replace an item in the cart](#Replace-an-item-in-the-cart)
  - [G. Delete an item in the cart](#Delete-an-item-in-the-cart)
- [Orders](#Orders)
